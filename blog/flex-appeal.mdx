...
# description: Pool-based lending is dead. The market just doesn't know it yet. Limitations in collateral born from the pool model are holding back onchain lending.
slug: flex-appeal
tags: ['product']
image: 'src/static/posts/flex-appeal.png'
hide_table_of_contents: false
date: 02-13-2025
---

<!-- truncate -->
![](../static/img/posts/flex-appeal.png)
